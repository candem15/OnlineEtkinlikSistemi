...
namespace OES.API.Persistence.Migrations
{
    ...
    [Migration("20221013231542_Migration_9")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OES.API.Domain.Entities.Identity.BaseIdentity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e2a380d6-21c1-4c83-ab87-53ac2e937e13",
                            Email = "admin@admin.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            Name = "admin",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEAXNckfRvujrGGZls1TDPGMTxZYvU3GlxsuER/gy1FwDilUEoj3CwhhepP5yJITCzw==",
            ...
            modelBuilder.Entity("OES.API.Domain.Identity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a1e7465c-ce5a-4c5a-b6b9-0b8de6183bd4",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e6c2c7ae-a6da-4d0a-8e7e-bc9878bf5e75",
                            Name = "Basit",
                            NormalizedName = "BASIT"
                        });
                });

            modelBuilder.Entity("OES.API.Domain.Entities.Identity.AppCompany", b =>
                {
                    b.HasBaseType("OES.API.Domain.Entities.Identity.BaseIdentity");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OES.API.Domain.Entities.Identity.BaseIdentity", null)
                        .WithMany()
